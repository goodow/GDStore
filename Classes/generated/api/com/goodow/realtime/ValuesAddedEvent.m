...
- (id)initWithGDRCollaborativeList:(GDRCollaborativeList *)target
  ...
  if (self = [super initWithGDREventTypeEnum:[GDREventTypeEnum VALUES_ADDED] withGDRCollaborativeObject:target withNSString:sessionId withNSString:userId withBoolean:NO]) {
    self->index_ = index;
    self->values_ = values;
  }
  return self;
