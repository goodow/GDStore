...
- (id)initWithGDRCollaborativeString:(GDRCollaborativeString *)target
  ...
  if (self = [super initWithGDREventTypeEnum:[GDREventTypeEnum TEXT_DELETED] withGDRCollaborativeObject:target withNSString:sessionId withNSString:userId withBoolean:NO]) {
    self->index_ = index;
    self->text_ = text;
  }
  return self;
