...
- (id)getWithNSString:(NSString *)key {
  ...
  return (id) [ComGoodowRealtimeStoreImplJsonSerializer deserializeObjectWithComGoodowRealtimeJsonJsonArray:[((id<ComGoodowRealtimeJsonJsonObject>) nil_chk(snapshot_)) getArrayWithNSString:key] withComGoodowRealtimeJsonJsonObject:((ComGoodowRealtimeStoreImplModelImpl *) nil_chk(model_))->objects_];
}
...
- (void)putAndFireEventWithNSString:(NSString *)key
 withComGoodowRealtimeJsonJsonArray:(id<ComGoodowRealtimeJsonJsonArray>)newValue
  ...
  NSAssert(nil != newValue, @"/Users/retechretech/dev/workspace/realtime/realtime-store/src/main/java/com/goodow/realtime/store/impl/CollaborativeMapImpl.java:186 condition failed: assert null != newValue;");
  id newObject = [ComGoodowRealtimeStoreImplJsonSerializer deserializeObjectWithComGoodowRealtimeJsonJsonArray:newValue withComGoodowRealtimeJsonJsonObject:((ComGoodowRealtimeStoreImplModelImpl *) nil_chk(model_))->objects_];
...
- (void)removeAndFireEventWithNSString:(NSString *)key
                          withNSString:(NSString *)sessionId
                          withNSString:(NSString *)userId {
  NSAssert([self hasWithNSString:key], @"/Users/retechretech/dev/workspace/realtime/realtime-store/src/main/java/com/goodow/realtime/store/impl/CollaborativeMapImpl.java:203 condition failed: assert has(key);");
  id<ComGoodowRealtimeJsonJsonArray> oldValue = [((id<ComGoodowRealtimeJsonJsonObject>) nil_chk(snapshot_)) getArrayWithNSString:key];
  ...
  [((ComGoodowRealtimeStoreImplModelImpl *) nil_chk(model_)) addOrRemoveParentWithComGoodowRealtimeJsonJsonArray:oldValue withNSString:id__ withBoolean:NO];
  [self fireEventWithComGoodowRealtimeStoreBaseModelEvent:event];
  model_->bytesUsed_ -= ((int) [((NSString *) nil_chk([((id<ComGoodowRealtimeJsonJsonArray>) nil_chk(oldValue)) toJsonString])) length]);
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplCollaborativeMapImpl = { "CollaborativeMapImpl", "com.goodow.realtime.store.impl", NULL, 0x0, 18, methods, 1, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplCollaborativeMapImpl_$1 = { "$1", "com.goodow.realtime.store.impl", "CollaborativeMapImpl", 0x8000, 2, methods, 1, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplCollaborativeMapImpl_$2 = { "$2", "com.goodow.realtime.store.impl", "CollaborativeMapImpl", 0x8000, 2, methods, 2, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplCollaborativeMapImpl_$3 = { "$3", "com.goodow.realtime.store.impl", "CollaborativeMapImpl", 0x8000, 2, methods, 2, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplCollaborativeMapImpl_$4 = { "$4", "com.goodow.realtime.store.impl", "CollaborativeMapImpl", 0x8000, 2, methods, 2, fields, 0, NULL};
...
- (void)setWithNSString:(NSString *)key
  ...
  if (newValue == nil) {
    ...
    ((ComGoodowRealtimeStoreImplModelImpl *) nil_chk(this$0_->model_))->bytesUsed_ -= ((int) [((NSString *) nil_chk([((ComGoodowRealtimeOperationOperationComponent *) nil_chk(val$component_)) description])) length]);
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplCollaborativeMapImpl_$5 = { "$5", "com.goodow.realtime.store.impl", "CollaborativeMapImpl", 0x8000, 2, methods, 4, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplCollaborativeMapImpl_$6 = { "$6", "com.goodow.realtime.store.impl", "CollaborativeMapImpl", 0x8000, 2, methods, 3, fields, 0, NULL};
