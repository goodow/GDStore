...
#include "com/goodow/realtime/store/impl/DefaultValuesAddedEvent.h"
#include "com/goodow/realtime/store/impl/DefaultValuesRemovedEvent.h"
#include "com/goodow/realtime/store/impl/DefaultValuesSetEvent.h"
...
@implementation ComGoodowRealtimeStoreImplDefaultCollaborativeList
...
- (id<ComGoodowRealtimeJsonJsonArray>)asArray {
  ...
  [((id<ComGoodowRealtimeJsonJsonArray>) nil_chk(snapshot_)) forEachWithComGoodowRealtimeJsonJsonArray_ListIterator:[[ComGoodowRealtimeStoreImplDefaultCollaborativeList_$1 alloc] initWithComGoodowRealtimeStoreImplDefaultCollaborativeList:self withComGoodowRealtimeJsonJsonArray:objects]];
  return objects;
}
...
- (id)getWithInt:(int)index {
  ...
  return (id) [ComGoodowRealtimeStoreImplJsonSerializer deserializeObjectWithComGoodowRealtimeJsonJsonArray:[((id<ComGoodowRealtimeJsonJsonArray>) nil_chk(snapshot_)) getArrayWithInt:index] withComGoodowRealtimeJsonJsonObject:((ComGoodowRealtimeStoreImplDefaultModel *) nil_chk(model_))->objects_];
}
...
withComGoodowRealtimeJsonJsonArray:(id<ComGoodowRealtimeJsonJsonArray>)values {
  NSAssert(values != nil, @"/Users/retechretech/dev/workspace/realtime/realtime-store/src/main/java/com/goodow/realtime/store/impl/DefaultCollaborativeList.java:117 condition failed: assert values != null;");
...
- (id<ComGoodowRealtimeStoreIndexReference>)registerReferenceWithInt:(int)index
  ...
  [self checkIndexWithInt:index withBoolean:YES];
  return [((ComGoodowRealtimeStoreImplDefaultModel *) nil_chk(model_)) createIndexReferenceWithNSString:id__ withInt:index withBoolean:canBeDeleted];
}
...
withComGoodowRealtimeJsonJsonArray:(id<ComGoodowRealtimeJsonJsonArray>)values {
  NSAssert(values != nil, @"/Users/retechretech/dev/workspace/realtime/realtime-store/src/main/java/com/goodow/realtime/store/impl/DefaultCollaborativeList.java:196 condition failed: assert values != null;");
  if ([((id<ComGoodowRealtimeJsonJsonArray>) nil_chk(values)) length] == 0) {
...
- (id<ComGoodowRealtimeJsonJsonArray>)toJson {
  ...
  [((id<ComGoodowRealtimeJsonJsonArray>) nil_chk(snapshot_)) forEachWithComGoodowRealtimeJsonJsonArray_ListIterator:[[ComGoodowRealtimeStoreImplDefaultCollaborativeList_$2 alloc] initWithComGoodowRealtimeStoreImplDefaultCollaborativeList:self withComGoodowRealtimeJsonJsonArray:json]];
  return json;
}
...
withComGoodowRealtimeOperationOperationComponent:(ComGoodowRealtimeOperationOperationComponent *)component {
  [((id<ComGoodowRealtimeOperationOperation>) nil_chk(((id<ComGoodowRealtimeOperationOperation>) check_protocol_cast(component, @protocol(ComGoodowRealtimeOperationOperation))))) applyWithId:[[ComGoodowRealtimeStoreImplDefaultCollaborativeList_$3 alloc] initWithComGoodowRealtimeStoreImplDefaultCollaborativeList:self withNSString:sessionId withNSString:userId]];
}
...
withComGoodowRealtimeJsonJsonArray:(id<ComGoodowRealtimeJsonJsonArray>)values
  ...
  id<ComGoodowRealtimeJsonJsonArray> objects = [ComGoodowRealtimeJsonJson createArray];
  [((id<ComGoodowRealtimeJsonJsonArray>) nil_chk(values)) forEachWithComGoodowRealtimeJsonJsonArray_ListIterator:[[ComGoodowRealtimeStoreImplDefaultCollaborativeList_$4 alloc] initWithComGoodowRealtimeStoreImplDefaultCollaborativeList:self withComGoodowRealtimeJsonJsonArray:objects withInt:index]];
  id<ComGoodowRealtimeStoreValuesAddedEvent> event = [[ComGoodowRealtimeStoreImplDefaultValuesAddedEvent alloc] initWithComGoodowRealtimeJsonJsonObject:[((id<ComGoodowRealtimeJsonJsonObject>) nil_chk([((id<ComGoodowRealtimeJsonJsonObject>) nil_chk([self eventWithNSString:sessionId withNSString:userId])) setWithNSString:@"index" withDouble:index])) setWithNSString:@"values" withId:objects]];
  [self fireEventWithComGoodowRealtimeStoreBaseModelEvent:event];
  [((ComGoodowRealtimeStoreImplDefaultModel *) nil_chk(model_)) setIndexReferenceIndexWithNSString:id__ withBoolean:YES withInt:index withInt:[values length] withNSString:sessionId withNSString:userId];
}
...
- (void)removeAndFireEventWithInt:(int)index
                     ...
                     withNSString:(NSString *)sessionId
                     withNSString:(NSString *)userId {
  NSAssert(index + length <= [self length], @"/Users/retechretech/dev/workspace/realtime/realtime-store/src/main/java/com/goodow/realtime/store/impl/DefaultCollaborativeList.java:321 condition failed: assert index + length <= length();");
  id<ComGoodowRealtimeJsonJsonArray> objects = [ComGoodowRealtimeJsonJson createArray];
  for (int i = 0; i < length; i++) {
    ...
    [((ComGoodowRealtimeStoreImplDefaultModel *) nil_chk(model_)) addOrRemoveParentWithComGoodowRealtimeJsonJsonArray:value withNSString:id__ withBoolean:NO];
    model_->bytesUsed_ -= ((int) [((NSString *) nil_chk([((id<ComGoodowRealtimeJsonJsonArray>) nil_chk(value)) toJsonString])) length]);
  }
  id<ComGoodowRealtimeStoreValuesRemovedEvent> event = [[ComGoodowRealtimeStoreImplDefaultValuesRemovedEvent alloc] initWithComGoodowRealtimeJsonJsonObject:[((id<ComGoodowRealtimeJsonJsonObject>) nil_chk([((id<ComGoodowRealtimeJsonJsonObject>) nil_chk([self eventWithNSString:sessionId withNSString:userId])) setWithNSString:@"index" withDouble:index])) setWithNSString:@"values" withId:objects]];
  [self fireEventWithComGoodowRealtimeStoreBaseModelEvent:event];
  [((ComGoodowRealtimeStoreImplDefaultModel *) nil_chk(model_)) setIndexReferenceIndexWithNSString:id__ withBoolean:NO withInt:index withInt:length withNSString:sessionId withNSString:userId];
}
...
withComGoodowRealtimeJsonJsonArray:(id<ComGoodowRealtimeJsonJsonArray>)values
                      withNSString:(NSString *)sessionId
                      withNSString:(NSString *)userId {
  NSAssert(index + [((id<ComGoodowRealtimeJsonJsonArray>) nil_chk(values)) length] <= [self length], @"/Users/retechretech/dev/workspace/realtime/realtime-store/src/main/java/com/goodow/realtime/store/impl/DefaultCollaborativeList.java:337 condition failed: assert index + values.length() <= length();");
  ...
  [values forEachWithComGoodowRealtimeJsonJsonArray_ListIterator:[[ComGoodowRealtimeStoreImplDefaultCollaborativeList_$5 alloc] initWithComGoodowRealtimeStoreImplDefaultCollaborativeList:self withComGoodowRealtimeJsonJsonArray:oldObjects withInt:index withComGoodowRealtimeJsonJsonArray:newObjects]];
  id<ComGoodowRealtimeStoreValuesSetEvent> event = [[ComGoodowRealtimeStoreImplDefaultValuesSetEvent alloc] initWithComGoodowRealtimeJsonJsonObject:[((id<ComGoodowRealtimeJsonJsonObject>) nil_chk([((id<ComGoodowRealtimeJsonJsonObject>) nil_chk([((id<ComGoodowRealtimeJsonJsonObject>) nil_chk([self eventWithNSString:sessionId withNSString:userId])) setWithNSString:@"index" withDouble:index])) setWithNSString:@"oldObjects" withId:oldObjects])) setWithNSString:@"newObjects" withId:newObjects]];
  [self fireEventWithComGoodowRealtimeStoreBaseModelEvent:event];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { "initWithComGoodowRealtimeStoreImplDefaultModel:", "DefaultCollaborativeList", NULL, 0x0, NULL },
    ...
    { "lengthWithInt:", "length", "V", 0x1, NULL },
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplDefaultCollaborativeList = { "DefaultCollaborativeList", "com.goodow.realtime.store.impl", NULL, 0x0, 31, methods, 1, fields, 0, NULL};
  return &_ComGoodowRealtimeStoreImplDefaultCollaborativeList;
}

@end

@implementation ComGoodowRealtimeStoreImplDefaultCollaborativeList_$1
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "initWithComGoodowRealtimeStoreImplDefaultCollaborativeList:withComGoodowRealtimeJsonJsonArray:", "init", NULL, 0x0, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "Lcom.goodow.realtime.store.impl.DefaultCollaborativeList;", NULL,  },
    { "val$objects_", NULL, 0x1012, "Lcom.goodow.realtime.json.JsonArray;", NULL,  },
  };
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplDefaultCollaborativeList_$1 = { "$1", "com.goodow.realtime.store.impl", "DefaultCollaborativeList", 0x8000, 2, methods, 2, fields, 0, NULL};
  return &_ComGoodowRealtimeStoreImplDefaultCollaborativeList_$1;
}

@end

@implementation ComGoodowRealtimeStoreImplDefaultCollaborativeList_$2
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplDefaultCollaborativeList_$2 = { "$2", "com.goodow.realtime.store.impl", "DefaultCollaborativeList", 0x8000, 2, methods, 2, fields, 0, NULL};
  return &_ComGoodowRealtimeStoreImplDefaultCollaborativeList_$2;
}

@end

@implementation ComGoodowRealtimeStoreImplDefaultCollaborativeList_$3
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "initWithComGoodowRealtimeStoreImplDefaultCollaborativeList:withNSString:withNSString:", "init", NULL, 0x0, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "Lcom.goodow.realtime.store.impl.DefaultCollaborativeList;", NULL,  },
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplDefaultCollaborativeList_$3 = { "$3", "com.goodow.realtime.store.impl", "DefaultCollaborativeList", 0x8000, 4, methods, 3, fields, 0, NULL};
  return &_ComGoodowRealtimeStoreImplDefaultCollaborativeList_$3;
}

@end

@implementation ComGoodowRealtimeStoreImplDefaultCollaborativeList_$4

- (void)callWithInt:(int)idx
             withId:(id<ComGoodowRealtimeJsonJsonArray>)value {
  (void) [((id<ComGoodowRealtimeJsonJsonArray>) nil_chk(val$objects_)) pushWithId:[ComGoodowRealtimeStoreImplJsonSerializer deserializeObjectWithComGoodowRealtimeJsonJsonArray:value withComGoodowRealtimeJsonJsonObject:((ComGoodowRealtimeStoreImplDefaultModel *) nil_chk(this$0_->model_))->objects_]];
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { "callWithInt:withComGoodowRealtimeJsonJsonArray:", "call", "V", 0x1, NULL },
    { "initWithComGoodowRealtimeStoreImplDefaultCollaborativeList:withComGoodowRealtimeJsonJsonArray:withInt:", "init", NULL, 0x0, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "Lcom.goodow.realtime.store.impl.DefaultCollaborativeList;", NULL,  },
    { "val$objects_", NULL, 0x1012, "Lcom.goodow.realtime.json.JsonArray;", NULL,  },
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplDefaultCollaborativeList_$4 = { "$4", "com.goodow.realtime.store.impl", "DefaultCollaborativeList", 0x8000, 2, methods, 3, fields, 0, NULL};
  return &_ComGoodowRealtimeStoreImplDefaultCollaborativeList_$4;
}

@end

@implementation ComGoodowRealtimeStoreImplDefaultCollaborativeList_$5
...
- (void)callWithInt:(int)idx
  ...
  (void) [((id<ComGoodowRealtimeJsonJsonArray>) nil_chk(val$newObjects_)) pushWithId:[ComGoodowRealtimeStoreImplJsonSerializer deserializeObjectWithComGoodowRealtimeJsonJsonArray:newValue withComGoodowRealtimeJsonJsonObject:((ComGoodowRealtimeStoreImplDefaultModel *) nil_chk(this$0_->model_))->objects_]];
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { "callWithInt:withComGoodowRealtimeJsonJsonArray:", "call", "V", 0x1, NULL },
    { "initWithComGoodowRealtimeStoreImplDefaultCollaborativeList:withComGoodowRealtimeJsonJsonArray:withInt:withComGoodowRealtimeJsonJsonArray:", "init", NULL, 0x0, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "Lcom.goodow.realtime.store.impl.DefaultCollaborativeList;", NULL,  },
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplDefaultCollaborativeList_$5 = { "$5", "com.goodow.realtime.store.impl", "DefaultCollaborativeList", 0x8000, 2, methods, 4, fields, 0, NULL};
  return &_ComGoodowRealtimeStoreImplDefaultCollaborativeList_$5;
}
