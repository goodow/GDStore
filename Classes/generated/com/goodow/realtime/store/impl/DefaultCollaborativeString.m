...
#include "com/goodow/realtime/store/impl/DefaultTextDeletedEvent.h"
#include "com/goodow/realtime/store/impl/DefaultTextInsertedEvent.h"
#include "java/lang/IllegalArgumentException.h"
#include "java/lang/StringBuilder.h"
#include "java/lang/StringIndexOutOfBoundsException.h"
#include "java/lang/UnsupportedOperationException.h"

@implementation ComGoodowRealtimeStoreImplDefaultCollaborativeString
...
- (void)setTextWithNSString:(NSString *)text {
  ...
  [((ComGoodowRealtimeStoreImplDefaultModel *) nil_chk(model_)) beginCompoundOperationWithNSString:@"replaceText"];
  [((id<ComGoodowRealtimeCoreDiff>) nil_chk([ComGoodowRealtimeCorePlatform diff])) diffWithNSString:[self getText] withNSString:text withComGoodowRealtimeCoreDiff_ListTarget:[[ComGoodowRealtimeStoreImplDefaultCollaborativeString_$1 alloc] initWithComGoodowRealtimeStoreImplDefaultCollaborativeString:self]];
...
withComGoodowRealtimeOperationOperationComponent:(ComGoodowRealtimeOperationOperationComponent *)component {
  [((id<ComGoodowRealtimeOperationOperation>) nil_chk(((id<ComGoodowRealtimeOperationOperation>) check_protocol_cast(component, @protocol(ComGoodowRealtimeOperationOperation))))) applyWithId:[[ComGoodowRealtimeStoreImplDefaultCollaborativeString_$2 alloc] initWithComGoodowRealtimeStoreImplDefaultCollaborativeString:self withNSString:sessionId withNSString:userId]];
}
...
- (void)deleteAndFireEventWithInt:(int)startIndex
  ...
  NSAssert(length > 0 && endIndex <= [self length], @"/Users/retechretech/dev/workspace/realtime/realtime-store/src/main/java/com/goodow/realtime/store/impl/DefaultCollaborativeString.java:161 condition failed: assert length > 0 && endIndex <= length();");
  NSString *toDelete = [((JavaLangStringBuilder *) nil_chk(snapshot_)) substringWithInt:startIndex withInt:endIndex];
  id<ComGoodowRealtimeStoreTextDeletedEvent> event = [[ComGoodowRealtimeStoreImplDefaultTextDeletedEvent alloc] initWithComGoodowRealtimeJsonJsonObject:[((id<ComGoodowRealtimeJsonJsonObject>) nil_chk([((id<ComGoodowRealtimeJsonJsonObject>) nil_chk([self eventWithNSString:sessionId withNSString:userId])) setWithNSString:@"index" withDouble:startIndex])) setWithNSString:@"text" withId:toDelete]];
  (void) [snapshot_ delete__WithInt:startIndex withInt:endIndex];
  [self fireEventWithComGoodowRealtimeStoreBaseModelEvent:event];
  [((ComGoodowRealtimeStoreImplDefaultModel *) nil_chk(model_)) setIndexReferenceIndexWithNSString:id__ withBoolean:NO withInt:startIndex withInt:length withNSString:sessionId withNSString:userId];
...
- (void)insertAndFireEventWithInt:(int)index
                     ...
                     withNSString:(NSString *)sessionId
                     withNSString:(NSString *)userId {
  NSAssert(index <= [self length], @"/Users/retechretech/dev/workspace/realtime/realtime-store/src/main/java/com/goodow/realtime/store/impl/DefaultCollaborativeString.java:173 condition failed: assert index <= length();");
  id<ComGoodowRealtimeStoreTextInsertedEvent> event = [[ComGoodowRealtimeStoreImplDefaultTextInsertedEvent alloc] initWithComGoodowRealtimeJsonJsonObject:[((id<ComGoodowRealtimeJsonJsonObject>) nil_chk([((id<ComGoodowRealtimeJsonJsonObject>) nil_chk([self eventWithNSString:sessionId withNSString:userId])) setWithNSString:@"index" withDouble:index])) setWithNSString:@"text" withId:text]];
  (void) [((JavaLangStringBuilder *) nil_chk(snapshot_)) insertWithInt:index withNSString:text];
  [self fireEventWithComGoodowRealtimeStoreBaseModelEvent:event];
  [((ComGoodowRealtimeStoreImplDefaultModel *) nil_chk(model_)) setIndexReferenceIndexWithNSString:id__ withBoolean:YES withInt:index withInt:((int) [((NSString *) nil_chk(text)) length]) withNSString:sessionId withNSString:userId];
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { "initWithComGoodowRealtimeStoreImplDefaultModel:", "DefaultCollaborativeString", NULL, 0x0, NULL },
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplDefaultCollaborativeString = { "DefaultCollaborativeString", "com.goodow.realtime.store.impl", NULL, 0x0, 16, methods, 1, fields, 0, NULL};
  return &_ComGoodowRealtimeStoreImplDefaultCollaborativeString;
}

@end

@implementation ComGoodowRealtimeStoreImplDefaultCollaborativeString_$1
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "initWithComGoodowRealtimeStoreImplDefaultCollaborativeString:", "init", NULL, 0x0, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "Lcom.goodow.realtime.store.impl.DefaultCollaborativeString;", NULL,  },
  };
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplDefaultCollaborativeString_$1 = { "$1", "com.goodow.realtime.store.impl", "DefaultCollaborativeString", 0x8000, 5, methods, 1, fields, 0, NULL};
  return &_ComGoodowRealtimeStoreImplDefaultCollaborativeString_$1;
}

@end

@implementation ComGoodowRealtimeStoreImplDefaultCollaborativeString_$2
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "insertWithInt:withNSString:", "insert", "V", 0x1, NULL },
    { "replaceWithInt:withNSString:", "replace", "V", 0x1, NULL },
    { "initWithComGoodowRealtimeStoreImplDefaultCollaborativeString:withNSString:withNSString:", "init", NULL, 0x0, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "Lcom.goodow.realtime.store.impl.DefaultCollaborativeString;", NULL,  },
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplDefaultCollaborativeString_$2 = { "$2", "com.goodow.realtime.store.impl", "DefaultCollaborativeString", 0x8000, 4, methods, 3, fields, 0, NULL};
  return &_ComGoodowRealtimeStoreImplDefaultCollaborativeString_$2;
}
