...
BOOL ComGoodowRealtimeStoreImplDefaultModel_initialized = NO;

@implementation ComGoodowRealtimeStoreImplDefaultModel

NSString * ComGoodowRealtimeStoreImplDefaultModel_ROOT_ID_ = @"root";
JavaUtilLoggingLogger * ComGoodowRealtimeStoreImplDefaultModel_log_;
...
- (id<ComGoodowRealtimeCoreRegistration>)onUndoRedoStateChangedWithComGoodowRealtimeCoreHandler:(id<ComGoodowRealtimeCoreHandler>)handler {
  return [((ComGoodowRealtimeStoreImplDefaultDocument *) nil_chk(document_)) addEventListenerWithNSString:nil withComGoodowRealtimeStoreEventTypeEnum:ComGoodowRealtimeStoreEventTypeEnum_get_UNDO_REDO_STATE_CHANGED() withComGoodowRealtimeCoreHandler:handler withBoolean:NO];
}

- (void)beginCompoundOperationWithNSString:(NSString *)opt_name {
  [((JavaUtilLoggingLogger *) nil_chk(ComGoodowRealtimeStoreImplDefaultModel_log_)) infoWithNSString:[NSString stringWithFormat:@"beginCompoundOperation%@", (opt_name == nil ? @"" : ([NSString stringWithFormat:@" %@", opt_name]))]];
}
...
- (id<ComGoodowRealtimeStoreCollaborativeMap>)createMapWithComGoodowRealtimeJsonJsonObject:(id<ComGoodowRealtimeJsonJsonObject>)opt_initialValue {
  ...
  if (opt_initialValue != nil && [opt_initialValue size] != 0) {
    [opt_initialValue forEachWithComGoodowRealtimeJsonJsonObject_MapIterator:[[ComGoodowRealtimeStoreImplDefaultModel_$1 alloc] initWithComGoodowRealtimeStoreImplDefaultModel:self withNSString:id_]];
  }
  [self endCompoundOperation];
  return [self getObjectWithNSString:id_];
}
...
- (void)endCompoundOperation {
  [((JavaUtilLoggingLogger *) nil_chk(ComGoodowRealtimeStoreImplDefaultModel_log_)) infoWithNSString:@"endCompoundOperation"];
}
...
- (id<ComGoodowRealtimeJsonJsonArray>)getParentsWithNSString:(NSString *)objectId {
  ...
  if (list != nil) {
    [list forEachWithComGoodowRealtimeJsonJsonArray_ListIterator:[[ComGoodowRealtimeStoreImplDefaultModel_$2 alloc] initWithComGoodowRealtimeJsonJsonArray:toRtn]];
  }
  return toRtn;
}

- (id<ComGoodowRealtimeStoreCollaborativeMap>)getRoot {
  return [self getObjectWithNSString:ComGoodowRealtimeStoreImplDefaultModel_ROOT_ID_];
}
...
- (void)addOrRemoveParentWithComGoodowRealtimeJsonJsonArray:(id<ComGoodowRealtimeJsonJsonArray>)childOrNull
  ...
  if ([((id<ComGoodowRealtimeJsonJsonArray>) nil_chk(childOrNull)) getNumberWithInt:0] == ComGoodowRealtimeStoreImplJsonSerializer_REFERENCE_TYPE) {
    ...
    if (isAdd) {
      ...
      NSAssert(list != nil && [list indexOfWithId:parentId] != -1, @"/Users/retechretech/dev/workspace/realtime/realtime-store/src/main/java/com/goodow/realtime/store/impl/DefaultModel.java:237 condition failed: assert list != null && list.indexOf(parentId) != -1;");
...
- (void)createRoot {
  [self beginCreationCompoundOperation];
  [((ComGoodowRealtimeStoreImplDocumentBridge *) nil_chk(bridge_)) consumeAndSubmitWithComGoodowRealtimeOperationOperationComponent:[[ComGoodowRealtimeOperationCreateCreateComponent alloc] initWithNSString:ComGoodowRealtimeStoreImplDefaultModel_ROOT_ID_ withInt:ComGoodowRealtimeOperationCreateCreateComponent_MAP]];
  [self endCompoundOperation];
}
...
- (void)setIndexReferenceIndexWithNSString:(NSString *)referencedObject
  ...
  if (cursors != nil) {
    [cursors forEachWithComGoodowRealtimeJsonJsonArray_ListIterator:[[ComGoodowRealtimeStoreImplDefaultModel_$3 alloc] initWithComGoodowRealtimeStoreImplDefaultModel:self withBoolean:isInsert withInt:index withInt:length withNSString:sessionId withNSString:userId]];
  }
}
...
+ (void)initialize {
  if (self == [ComGoodowRealtimeStoreImplDefaultModel class]) {
    ComGoodowRealtimeStoreImplDefaultModel_log_ = [JavaUtilLoggingLogger getLoggerWithNSString:[[IOSClass classWithProtocol:@protocol(ComGoodowRealtimeStoreModel)] getName]];
    ComGoodowRealtimeStoreImplDefaultModel_initialized = YES;
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { "initWithComGoodowRealtimeStoreImplDocumentBridge:withComGoodowRealtimeStoreImplDefaultDocument:", "DefaultModel", NULL, 0x0, NULL },
  ...
  static J2ObjcFieldInfo fields[] = {
    { "ROOT_ID_", NULL, 0x1a, "Ljava.lang.String;", &ComGoodowRealtimeStoreImplDefaultModel_ROOT_ID_,  },
    { "log_", NULL, 0x1a, "Ljava.util.logging.Logger;", &ComGoodowRealtimeStoreImplDefaultModel_log_,  },
    ...
    { "document_", NULL, 0x10, "Lcom.goodow.realtime.store.impl.DefaultDocument;", NULL,  },
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplDefaultModel = { "DefaultModel", "com.goodow.realtime.store.impl", NULL, 0x0, 25, methods, 12, fields, 0, NULL};
  return &_ComGoodowRealtimeStoreImplDefaultModel;
}

@end

@implementation ComGoodowRealtimeStoreImplDefaultModel_$1
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "initWithComGoodowRealtimeStoreImplDefaultModel:withNSString:", "init", NULL, 0x0, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "Lcom.goodow.realtime.store.impl.DefaultModel;", NULL,  },
    { "val$id_", NULL, 0x1012, "Ljava.lang.String;", NULL,  },
  };
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplDefaultModel_$1 = { "$1", "com.goodow.realtime.store.impl", "DefaultModel", 0x8000, 2, methods, 2, fields, 0, NULL};
  return &_ComGoodowRealtimeStoreImplDefaultModel_$1;
}

@end

@implementation ComGoodowRealtimeStoreImplDefaultModel_$2
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplDefaultModel_$2 = { "$2", "com.goodow.realtime.store.impl", "DefaultModel", 0x8000, 2, methods, 1, fields, 0, NULL};
  return &_ComGoodowRealtimeStoreImplDefaultModel_$2;
}

@end

@implementation ComGoodowRealtimeStoreImplDefaultModel_$3

- (void)callWithInt:(int)idx
             withId:(NSString *)indexReferenceId {
  ComGoodowRealtimeStoreImplDefaultIndexReference *indexReference = [this$0_ getObjectWithNSString:indexReferenceId];
  [((ComGoodowRealtimeStoreImplDefaultIndexReference *) nil_chk(indexReference)) setIndexWithBoolean:val$isInsert_ withInt:val$index_ withInt:val$length_ withNSString:val$sessionId_ withNSString:val$userId_];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { "callWithInt:withNSString:", "call", "V", 0x1, NULL },
    { "initWithComGoodowRealtimeStoreImplDefaultModel:withBoolean:withInt:withInt:withNSString:withNSString:", "init", NULL, 0x0, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "Lcom.goodow.realtime.store.impl.DefaultModel;", NULL,  },
  ...
  static J2ObjcClassInfo _ComGoodowRealtimeStoreImplDefaultModel_$3 = { "$3", "com.goodow.realtime.store.impl", "DefaultModel", 0x8000, 2, methods, 6, fields, 0, NULL};
  return &_ComGoodowRealtimeStoreImplDefaultModel_$3;
}
