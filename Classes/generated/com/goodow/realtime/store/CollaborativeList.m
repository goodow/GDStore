...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoodowRealtimeStoreCollaborativeList = { 1, "CollaborativeList", "com.goodow.realtime.store", NULL, 0x201, 20, methods, 0, NULL, 0, NULL};
  return &_ComGoodowRealtimeStoreCollaborativeList;
}

@end

J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(ComGoodowRealtimeStoreCollaborativeList)
