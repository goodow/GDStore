...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoodowRealtimeStoreCollaboratorLeftEvent = { 1, "CollaboratorLeftEvent", "com.goodow.realtime.store", NULL, 0x201, 2, methods, 0, NULL, 0, NULL};
  return &_ComGoodowRealtimeStoreCollaboratorLeftEvent;
}

@end

J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(ComGoodowRealtimeStoreCollaboratorLeftEvent)
